...
namespace ProductService.Domain
{
    public class OrderingDBReadOnlyContext : OrderingDBContext
    {
        ...
        {
            throw new FriendlyException(403, $"ReadOnlyDBContext SaveChanges is forbidden.");
        ...
        {
            throw new FriendlyException(403, $"ReadOnlyDBContext SaveChangesAsync is forbidden.");
